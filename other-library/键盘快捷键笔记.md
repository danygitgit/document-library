@[键盘快捷键笔记](https://github.com/danygitgit/document-library/blob/master/other-library/Git%E7%AC%94%E8%AE%B0/Git%E5%91%BD%E4%BB%A4%E5%85%A5%E9%97%A8.md)

> create by **db** on **2018-12-230 15:42:36**   
> Recently revised in **2018-12-30 15:42:31**
...
&emsp;作为一只前端菜鸟，这是我掘金分享的第二篇文章。如有不足，还请多多指教，谢谢大家。
...
**这——就是键盘！**
![alt](../../public-repertory/img/Git-img/Varmilo.png)
————有木有流口水呢~~

## 键盘前生今世

没图说个 * * 
![](../../public-repertory/img/Git-img/Keyboard.jpg)
...
&emsp;在很多情况下，键盘操作比鼠标操作更便捷，更灵活，也更能装 X。。。当然最重要的还是能提高工作效率。这样不用多久，你就会升职加薪、当上总经理、出任CEO、迎娶白富美、走上人生巅峰，想想是不是点小激动呢。

&emsp;废话不多说了，开始我们的键盘快捷键之旅。

## 键盘分区

![](../../public-repertory/img/Git-img/KeyboardPartition.jpg)
...
* 功能键区
    - 功能键区位千键盘的最上方，共有16个键，包括Esc键、Sleep键、F1～F12键、WakeUp键和Power键。
...
* 状态指示区
    - 状态指示区具有CapsLock（字母大键盘小写锁定）、NumLock（数字小键盘锁定）、ScrollLock（滚动锁定键）三个指示灯。
...
快捷键     | 功能
-------- | -----
<font color=red><kbd>Window</kbd> + <kbd>D</kbd> | 快速回到桌面
<font color=red><kbd>Window</kbd> + <kbd>E</kbd> | 快速打开计算机 
<font color=red><kbd>Window</kbd> + <kbd>L</kbd> | 快速锁定电脑
